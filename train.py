...
#  ipdb.set_trace()
  ...
  if not steps_per_external_eval:
    steps_per_external_eval = 15 * steps_per_eval
...
#  while True:
#    try:
#      aa = train_sess.run(loaded_train_model.iterator.target_output)
#      ls.append(aa.shape[1])
#    except tf.errors.OutofRangeError:
#      import ipdb
#      ipdb.set_trace()
#      print('hello')
  print('global_step is %d' %(global_step))
  ls_bleu = []
  while global_step < num_train_steps:
    ...
    try:
      ...
      vali_bleu, _, _ = run_external_eval(infer_model, infer_sess, model_dir, hparams,
                        summary_writer)
      ls_bleu.append(vali_bleu)
      print(ls_bleu)
